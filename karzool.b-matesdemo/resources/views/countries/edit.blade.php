		...
		<div class="row">
              ...
              <div class="col-lg-6">
                <div class="p-5">
                    ...
                    <form class="user" method="POST" action="/editCountry/{{$editInfo['id'] }}" enctype="multipart/form-data">
				    @csrf
					...
					<div class="form-group">
					  ...
					  Flag
					   @if($editInfo['flag'])
					   <img src="/upload-flag/{{$editInfo['flag']}}" style="width:75px;">
					   @endif
					   ...
					   <input id="class-browse" type="file" name="flag" style="display:none;">
					   <input type="hidden" name="flag-old" value="{{$editInfo['flag']}}">
					  </div>
					...
					<div class="form-group">
                       Code : 
						<input id="" type="text" required class="form-control form-control-user" name="c_code" value="{{$editInfo['c_code']}}" autofocus placeholder="Enter Country Code" style="align:center;width:400px;">
					</div>
