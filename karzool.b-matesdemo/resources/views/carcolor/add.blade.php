...
@include('layouts.top')
      ...
      <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-4 text-gray-800">New Car Color</h1>
		  <div class="col-md-2 mb-8 mb-sm-2 float-right">
			...
			<div class="row">
              ...
              <div class="col-lg-6">
                <div class="p-5">
                  <form class="user" method="POST" action="/addCarColor">
                    @csrf
					...
					<div class="form-group">
                       Color : #<input name="icon_color" required type="text" class="form-control form-control-user" id="carColor" data-wheelcolorpicker>
                    </div>
