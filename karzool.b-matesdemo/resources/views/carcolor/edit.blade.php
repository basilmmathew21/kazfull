...
@include('layouts.top')
		...
		<h1 class="h3 mb-2 text-gray-800">Edit Car Color</h1>
		...
		<div class="row">
              ...
              <div class="col-lg-6">
                <div class="p-5">
                    ...
                    <form class="user" method="POST" action="/editCarColor/{{$editInfo['id'] }}" enctype="multipart/form-data">
				    @csrf
					...
					<div class="form-group">
                       Color : #<input name="icon_color" required type="text" class="form-control form-control-user" id="carColor" value="{{ $editInfo['icon_color'] }}"  data-wheelcolorpicker>
                    </div>
