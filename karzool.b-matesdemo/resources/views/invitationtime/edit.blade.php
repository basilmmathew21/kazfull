		...
		<div class="row">
			<div class="col-lg-6">
                <div class="p-5">
                    ...
                    <form id="generateForm" class="user" method="POST" action="/editGeneralSettingAmount/{{$editInfo['id'] }}">
				    @csrf
                    
					<div class="form-group">
					Amount : 
					   <input name="amount" required value="{{$editInfo['amount']}}" type="text" class="form-control-2 form-control-user" id="amount">
                    </div>
